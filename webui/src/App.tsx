...
function App() {
  ...
  return (
    <AuthGate>
      <div className="relative h-screen w-full bg-paper text-stone-800 font-sans overflow-hidden antialiased">
        {/* Base Layer: Sidebar and Timeline (with Tab Navigation) */}
        ...
        {/* Global Navigation Layer - Apple Styled Tab Bar */}
        {isMobile && (
        ...
        {/* Overlay Layer: Letter View (Stacks on top of everything) */}
        <AnimatePresence>
          {selectedLetterId && (
            <motion.div
        ...
        {!isMobile && !selectedLetterId && (
          <div className="flex-1 flex items-center justify-center bg-[#f8f6f2] text-stone-300">
